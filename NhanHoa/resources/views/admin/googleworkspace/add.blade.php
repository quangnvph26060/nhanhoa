        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title" style="text-align: center; color:white">Thêm Google Workspace <span id="text-business" style="display: block">Business</span> <span id="text-education" style="display: none">Education</span></h4>
                </div>
                <div style="padding: 10px">
                    <button id="business-btn" class="btn btn-success mr-5" onclick="showSection('business-btn', 'business', 'text-business')">Business</button>
                    <button id="education-btn" class="btn btn-secondary" onclick="showSection('education-btn', 'education', 'text-education')">Education</button>
                </div>
                <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-lg-6 add_product">
                                        ...
                                        <div>
                                            ...
                                            <input type="text" class="form-control" name="storage_capacity" id="storage_capacity" required>
                                            <div class="col-lg-9">
                                                <span class="invalid-feedback d-block" style="font-weight: 500"
                                        ...
                                        <div>
                                            ...
                                            <input type="number" class="form-control" name="price_first_20_users" id="price_first_20_users">
                                            <div class="col-lg-9">
                                                <span class="invalid-feedback d-block" style="font-weight: 500"
                                    ...
                                    <div class="col-lg-6 add_product">
                                        <div>
                                            ...
                                            <input type="number" class="form-control" name="price_after_20_users" id="price_after_20_users">
                                            <div class="col-lg-9">
                                                <span class="invalid-feedback d-block" style="font-weight: 500"
                                        ...
                                        <div>
                                            ...
                                            <input type="number" class="form-control" name="renewal_price" id="renewal_price">
                                            <div class="col-lg-9">
                                                <span class="invalid-feedback d-block" style="font-weight: 500"
                                ...
                                <div class="row">
                                    <div class="col-lg-6 add_product">
                                        ...
                                        <div>
                                           ...
                                           <textarea name="describe" class="form-control" id="describe" cols="20"></textarea>
                                            <div class="col-lg-9">
                                                <span class="invalid-feedback d-block" style="font-weight: 500"
                                    ...
                                    <div class="col-lg-6 add_product">
                                        ...
                                        <div>
                                           ...
                                           <textarea name="storage" class="form-control" id="storage" cols="20"></textarea>
                                            <div class="col-lg-9">
                                                <span class="invalid-feedback d-block" style="font-weight: 500"
