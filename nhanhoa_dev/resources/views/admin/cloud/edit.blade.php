        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title" style="text-align: center; color:white">Sửa Cloud</h4>
                </div>
                <div class="card-body">
                    <div class="">
                                ...
                                <div class="row">
                                    <div class="col-lg-6 add_product">
                                        ...
                                        <div>
                                            ...
                                            <input type="text" class="form-control" name="name" id="name1" value="{{ $cloud->name }}" placeholder="VD: Sinh viên +">
                                            <div class="col-lg-9">
