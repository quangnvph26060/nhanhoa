        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Thay đổi thông tin đối tác</h4>
                </div>
                    <div class="card-body">
                        <form method="POST" action="{{ route('admin.partner.editsubmit', ['id'=>$partner->id]) }}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row">
                                <div class="col-lg-6 add_product">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="name" id="name" value="{{ $partner->name }}" required>
