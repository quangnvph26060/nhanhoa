        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title" style="text-align: center; color:white">Danh sách đánh giá</h4>
                </div>
                <div class="card-body">
                                    ...
                                    <table id="basic-datatables"
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $item->web }}</td>
                                                <td align="center">
                                                    <a class="btn btn-warning" href="{{ route('admin.reviews.show', ['id' => $item->id]) }}"><i class="fas fa-edit"></i></a>
