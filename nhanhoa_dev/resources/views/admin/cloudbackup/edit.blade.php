        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title" style="text-align: center; color:white">Sửa Cloud Backup</h4>
                </div>
                <div class="card-body">
                    <div class="">
                                ...
                                <div class="row">
                                    <div class="col-lg-6 add_product">
                                        ...
                                        <div>
                                            ...
                                            <select class="form-select" name="backuptype" id="backuptype">
                                                ...
                                                <option {{ $cloud->backuptype == 1 ? 'selected' : '' }} value="1">Cloud VPS </option>
                                                <option {{ $cloud->backuptype == 1 ? 'selected' : '' }} value="2">Cloud Server </option>
                                            </select>
                                            <div class="col-lg-9">
                                                <span class="invalid-feedback d-block" style="font-weight: 500"
                                        ...
                                        <div>
                                            ...
                                            <input type="text" class="form-control" name="package_applied" id="package_applied" value="{{ $backup->package_applied }}">
                                            <div class="col-lg-9">
                                                <span class="invalid-feedback d-block" style="font-weight: 500"
                                    ...
                                    <div class="col-lg-6 add_product">
                                        <div>
                                            ...
                                            <input type="text" class="form-control" name="max_storage" id="max_storage" value="{{ $backup->max_storage }}">
                                            <div class="col-lg-9">
                                                <span class="invalid-feedback d-block" style="font-weight: 500"
                                        ...
                                        <div>
                                            ...
                                            <input type="text" class="form-control" name="backup_time" id="backup_time" value="{{ $backup->backup_time }}">
                                            <div class="col-lg-9">
                                                <span class="invalid-feedback d-block" style="font-weight: 500"
                                        ...
                                        <div>
                                            ...
                                            <input type="number" class="form-control" name="backup_count" id="backup_count" value="{{ $backup->backup_count }}">
                                            <div class="col-lg-9">
                                                <span class="invalid-feedback d-block" style="font-weight: 500"
