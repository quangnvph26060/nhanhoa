        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title" style="text-align: center; color:white">Danh sách Cloud Backup</h4>
                </div>
                <div class="card-body">
                                    ...
                                    <table id="basic-datatables"
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $item->price }}</td>
                                                <td>{{ $item->package_applied }}</td>
                                                <td>{{ $item->max_storage }}GB</td>
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <p><strong>Gói áp dụng:</strong> {{ $item->package_applied }}</p>
                                                            <p><strong>Dung lượng tối đa:</strong> {{ $item->max_storage }} GB</p>
                                                            <p><strong>Thời gian sao lưu:</strong> {{ $item->backup_time }}</p>
                                                            <p><strong>Số bản sao lưu:</strong> {{ $item->backup_count }}</p>
                                                        </div>
