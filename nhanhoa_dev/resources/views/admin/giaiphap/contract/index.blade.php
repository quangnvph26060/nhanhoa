        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title" style="text-align: center; color:white">Danh sách hợp đồng điện tử ESOC</h4>
                </div>

                <div class="card-body">
                    <div class="">
                        <a href="{{ route('admin.giaiphap.contractesoc.addform') }}" class="btn btn-primary"> Thêm </a>
                     </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><a href="#" data-toggle="modal"
                                            data-target="#productModal{{ $key }}">ESOC - {{ $item->contract_number }}</a></td>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <p><strong>Tên: </strong> ESOC - {{ $item->contract_number }}</p>
                                                <p><strong>Giá: </strong> {{ number_format($item->price) }} đ/Tháng</p>
                                                <p><strong>Thời gian lưu trữ: </strong> {{ $item->storage_duration }}</p>
                                                <p><strong>Thời gian sử dụng: </strong> {{ $item->usage_duration }}</p>
                                                <p><strong>Không gian lưu trữ: </strong> {{ $item->storage_type }}</p>
                                                <p><strong>Hệ thống ổ đĩa truy xuấ: </strong> {{ $item->storage_system }}</p>
                                                <p><strong>Bảo trì, Bản quyền: </strong> {{ number_format($item->maintenance_fee) }}</p>
