        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title" style="text-align: center; color:white">Sửa gói dịch vụ quản trị máy chủ
                    </h4>
                </div>
                <div class="card-body">
                    <div class="">
                        <div id="basic-datatables_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap4">
                            <form method="POST" id="service" enctype="multipart/form-data" action="{{ route('admin.service.editsubmit', ['id' => $service->id]) }}">
                                @csrf
                                <div class="row g-4">
                                    <!-- Các input text -->
                                    <div class="col-6">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                ...
                                                <div class="form-check form-switch mb-2">
                                                    ...
                                                    {{ $service->server_optimization == 1 ? 'checked' : '' }}
                                                    >
                                                ...
                                                <div class="form-check form-switch mb-2">
                                                    ...
                                                    {{ $service->server_security == 1 ? 'checked' : '' }}>
                                                ...
                                                <div class="form-check form-switch mb-2">
                                                    ...
                                                    {{ $service->backup_configuration == 1 ? 'checked' : '' }}>
                                                ...
                                                <div class="form-check form-switch mb-2">
                                                    ...
                                                    {{ $service->basic_monitoring == 1 ? 'checked' : '' }}>
                                                 ...
                                                 <div class="form-check form-switch mb-2">
                                                    ...
                                                    {{ $service->advanced_monitoring == 1 ? 'checked' : '' }}>
                                            ...
                                            <div class="col-6">
                                                ...
                                                <div class="form-check form-switch mb-2">
                                                    ...
                                                    {{ $service->incident_reporting == 1 ? 'checked' : '' }}>
                                                ...
                                                <div class="form-check form-switch mb-2">
                                                    ...
                                                    {{ $service->periodic_reporting_by_email == 1 ? 'checked' : '' }}>
