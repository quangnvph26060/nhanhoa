                                ...
                                <div class="row g-4">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control border border-primary" name="name" id="name" placeholder="VD: QUẢN TRỊ CƠ BẢN">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control border border-primary" name="category_implementation" id="category_implementation" placeholder=" VD: 15 phút">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control border border-primary" name="website_data_migration" id="website_data_migration" placeholder="VD: Tối đa 10 website hoặc 50GB/tháng">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control border border-success" name="price" id="price"  placeholder="VD: Nhập giá">
