            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title" style="text-align: center; color:#fff">Thêm giải pháp mới</h4>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="new-solution-name" name="name"
                                            required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="new-solution-fee" name="fee">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="new-solution-initialization_fee"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="new-solution-branch" name="branch"
                                            required>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="new-solution-record_capacity"
                                            name="record_capacity" required>
                                    </div>
                                </div>
                            </div>
                            <div class="text-center">
                                <button type="submit" class="btn btn-primary" id="confirm-button" disabled>Lưu</button>
                            </div>
                        </form>
                    </div>
                </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function checkFormValidity() {
                const isFormValid = initializationFeeInput.value.trim() !== '' &&
                    nameInput.value.trim() !== '' &&
                    branchInput.value.trim() !== '' &&
                    recordCapacityInput.value.trim() !== '';
