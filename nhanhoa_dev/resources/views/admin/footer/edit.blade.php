                    ...
                    <div class="">
                        <div id="basic-datatables_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap4">
                            <form method="POST"  id="addcloud"
                                action="{{ route('admin.config.footer.update', ['id' => $footer->id]) }}">
                                @csrf
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 add_product">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" value="{{ $footer->title }}" name="title" id="title" placeholder="">
                                            <div class="col-lg-9">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" id="description" name="description" rows="5"
                                                placeholder="Mô tả ">{{ $footer->description }}</textarea>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select id="multiple-select" class="form-control" name="new[]" multiple>
                                                ...
                                                <option {{ in_array($item->id, $newselect) ? 'selected' : '' }} value="{{ $item->id }}">{{ $item->title }}</option>
                                                @empty
