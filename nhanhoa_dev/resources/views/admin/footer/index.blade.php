        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title" style="text-align: center; color:white">Danh sách Footer</h4>
                </div>
                <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-md-12">
                                    <div class="dataTables_length" id="basic-datatables_length">
                                        <a class="btn btn-primary" href="{{ route('admin.config.footer.add') }}">Thêm
                                            mới</a>
                                    </div>
                                </div>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="#" data-toggle="modal"
                                                        data-target="#productModal{{ $key }}">{{ $item->title }}</a></td>
                                                <td>{{ $item->description }}</td>
                                                <td align="center">
                                                    <a class="btn btn-warning" href="{{ route('admin.config.footer.edit', ['id' => $item->id]) }}"><i class="fas fa-edit"></i></a>
                                                    <button class="btn btn-danger btn-delete" data-id="{{ $item->id }}"
                                                        onclick="deleteConfirmation({{ $item->id }})"><i
                                                            class="fa-solid fa-trash"></i></button>

                                                    <form id="delete-form-{{ $item->id }}" action="{{ route('admin.config.footer.delete', ['id' => $item->id]) }}" method="POST"
                                                        style="display: none;">
                                                        @csrf
                                                    </form>
                                                </td>
