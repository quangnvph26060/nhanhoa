                        ...
                        <div class="row">
                            <div class="col-lg-6 add_product">
                                ...
                                <div>
                                    ...
                                    <input type="text" class="form-control" name="bw_in_country" id="bw_in_country"
                                        required>
                                    <div class="col-lg-9">
                                        <span class="invalid-feedback d-block" style="font-weight: 500"
                                ...
                                <div>
                                    ...
                                    <input type="text" class="form-control" name="bw_international"
                                ...
                                <div>
                                    ...
                                    <input type="text" class="form-control" name="data_transfer" id="data_transfer">
                                    <div class="col-lg-9">
                                        <span class="invalid-feedback d-block" style="font-weight: 500"
                                ...
                                <div>
                                    ...
                                    <input type="text" class="form-control" name="rack_space" id="rack_space">
                                    <div class="col-lg-9">
                                        <span class="invalid-feedback d-block" style="font-weight: 500"
                            ...
                            <div class="col-lg-6 add_product">
                                <div>
                                    ...
                                    <input type="text" class="form-control" name="power_capacity" id="power_capacity">
                                    <div class="col-lg-9">
                                        <span class="invalid-feedback d-block" style="font-weight: 500"
                                ...
                                <div>
                                    ...
                                    <select class="form-select" name="ups_backup" id="ups_backup">
                                ...
                                <div>
                                    ...
                                    <select class="form-select" name="air_conditioning" id="air_conditioning">
                                        <option value="">--- Chọn ---</option>
                                        <option value="Có">Có</option>
                                        <option value="Không">Không</option>
                                    </select>
                                ...
                                <div>
                                    ...
                                    <input type="text" class="form-control" name="network_socket" id="network_socket">
                                    <div class="col-lg-9">
                                        <span class="invalid-feedback d-block" style="font-weight: 500"
                                ...
                                <div>
                                    ...
                                    <input type="number" class="form-control" name="ip_address" id="ip_address">
                                    <div class="col-lg-9">
                                        <span class="invalid-feedback d-block" style="font-weight: 500"
