<div id="SECTION9" class="ladi-section">
    ...
    <div class="ladi-container">
        <div id="HEADLINE37" class="ladi-element">
            <h3 class="ladi-headline">Câu hỏi thường gặp<br /></h3>
        </div>
                ...
                <div id="SHAPE1" class="ladi-element">
                    <div class="ladi-shape">
                        <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%"
                            ...
                            fill="rgba(79, 203, 220, 1)">
                            <use xlink:href="#shape_TbOougpfXL"></use>
                        </svg>
                    </div>
                </div>
                <div id="HEADLINE38" class="ladi-element">
                    <h3 class="ladi-headline">Cloud Storage là gì?<br /></h3>
                </div>
                <div id="PARAGRAPH37" class="ladi-element">
                    <div class="ladi-paragraph">
                        Cloud Storage là một dịch vụ lưu trữ dữ liệu trên môi trường điện toán đám mây. Cloud
                        Storage có nhiều ưu điểm vượt trội so với các hình thức lưu trữ thông thường như cho
                        phép truy cập dữ liệu mọi lúc mọi
                        nơi qua internet, khả năng mở rộng linh hoạt theo nhu cầu người dùng, độ an toàn và bảo
                        mật dữ liệu cao.
                    </div>
                </div>
        ...
        <div id="GROUP23" class="ladi-element">
            <div class="ladi-group">
                ...
                <div id="HEADLINE48" class="ladi-element">
                    <h3 class="ladi-headline">5<br /></h3>
                </div>
            </div>
        </div>
        <div id="GROUP24" class="ladi-element">
            <div class="ladi-group">
                ...
                <div id="HEADLINE50" class="ladi-element">
                    <h3 class="ladi-headline">6<br /></h3>
                </div>
            </div>
        </div>
    </div>
