    ...
    <ul class="listoptionservice">
        <li class=" wow fadeInUp" data-wow-delay="0.2s">
            ...
            <div class="blockItemservice">
                <img alt="Tiết kiệm chi phí" src="thumb/80x80/1/upload/baiviet/tietkiemchiphi9751-41891679392246.png"
                    class="logohover">
                <img alt="Tiết kiệm chi phí" src="thumb/80x80/1/upload/baiviet/tietkiemchiphi9751-4189.png">
        ...
        <li class=" wow fadeInUp" data-wow-delay="0.4s">
            ...
            <div class="blockItemservice">
                <img alt="Dễ dàng sử dụng" src="thumb/80x80/1/upload/baiviet/dedangsudung921-68241679392236.png"
                    class="logohover">
        ...
        <li class=" wow fadeInUp" data-wow-delay="0.6s">
            ...
            <div class="blockItemservice">
                <img alt="Tính năng hữu ích" src="thumb/80x80/1/upload/baiviet/tinhnanghuuich3335-76311679392227.png"
                    class="logohover">
                <img alt="Tính năng hữu ích" src="thumb/80x80/1/upload/baiviet/tinhnanghuuich3335-7631.png">
        ...
        <li class=" wow fadeInUp" data-wow-delay="0.8s">
            ...
            <div class="blockItemservice">
                <img alt="Mở rộng không giới hạn" src="thumb/80x80/1/upload/baiviet/morong9566-25621679392216.png"
                    class="logohover">
    ...
    <div class="container padding0">
        ...
        <div class="contentPagelistPrice linefixrow">
            ...
            <div class="section_cta text-center">
                <a href="{{ route('page.price-list') }}" class="btn_cta_price">Xem bảng giá chi tiết</a>
            </div>
        ...
        <script>
            $().ready(function() {
                    $('.goidichvu').change(function() {
                        valDichvu = $('option:selected', this).attr('data-id');
                        $.ajax({
                            type: "POST",
                            url: "ajax/getgiadichvu.php",
                            data: {
                                valDichvu: valDichvu
                            },
                            success: function(result) {
                                $('.giagoidichvu').html(result);
                            }
                        });
                    })
        ...
        <div id="dangkygoidichvu" style="display:none;">
            ...
            <form action="thong-bao.html" method="post" accept-charset="utf-8">
                <ul class="listinforegiste">
                    ...
                    <li>
                        <input type="text" required="required" name="dienthoai" placeholder="Số điện thoại">
                    </li>
                    <li>
                        <select name="khuvuc">
                    ...
                    <li>
                        ...
                        <ul class="listvande">
                            ...
                            <li><input id="input532" type="checkbox" name="vande"
                                    value="Kết nối không giới hạn đầu số cố định, 1900/ 1800"> <label for="input532">Kết
                                    nối không giới hạn đầu số cố định, 1900/ 1800</label>
                            </li>
                            ...
                            <li><input id="input535" type="checkbox" name="vande"
                                    value="Gọi vào/ ra trực tiếp từ trình duyệt Web"> <label for="input535">Gọi vào/
                                    ra trực tiếp từ trình duyệt Web</label>
                            </li>
                            <li><input id="input536" type="checkbox" name="vande" value="Ứng dụng " VFone" trên iOS/
                                    Android"> <label for="input536">Ứng dụng "VFone" trên iOS/
                                    Android</label>
                            </li>
                            <li><input id="input537" type="checkbox" name="vande"
                                    value="Cài đặt máy nhánh đơn giản với mã QR Code"> <label for="input537">Cài đặt
                                    máy nhánh đơn giản với mã QR Code</label>
                            </li>
                    ...
                    <li class="linebtnr"><input type="hidden" name="trff" value="VFONE_nhanhoa.com"><button><span>Đăng
                                ký</span></button></li>
            ...
            <div class="container padding0">
                ...
                <div class="conentenPri wow fadeInUp" data-wow-delay="0.2s">
                        ...
                        <li>
                            <div class="priLi wow fadeInUp" data-wow-delay="0.15s">
                                ...
                                <a href="javascript:void(0)">
                                    ...
                                    <img alt="Kết nối  không giới hạn đầu số" src="upload/hinhanh/305484172597346.png">
                                    <span>Kết nối không giới hạn
                                        đầu số</span> </a>
                            </div>
                        </li>
                        <li>
                        ...
                        <li>
                            <div class="priLi wow fadeInUp" data-wow-delay="0.21s">
                                ...
                                <a href="javascript:void(0)">
                                    ...
                                    <img alt="Gọi tự động  CSKH/ bán hàng" src="upload/hinhanh/937674331060856.png">
                                    <span>Gọi tự động CSKH/ bán
                                        hàng</span> </a>
                            </div>
                        </li>
                        <li>
                    ...
                    <ul class="listPrce1 wow fadeInUp" data-wow-delay="0.24s">
                        ...
                        <li>
                            <div class=" "><a href="javascript:void(0)"><img alt="Gọi trực tiếp  từ trình duyệt Web"
                                        src="upload/hinhanh/038846145572385.png"> <span>Gọi trực tiếp từ trình
                                        duyệt Web</span> </a></div>
                        </li>
                        <li>
                            <div class=" "><a href="javascript:void(0)"><img alt="Mở rộng máy nhánh  không giới hạn"
                                        src="upload/hinhanh/504641162166951.png"> <span>Mở rộng máy nhánh không
                                        giới hạn</span> </a></div>
                        </li>
                        <li>
                        ...
                        <li>
                            <div class=" "><a href="javascript:void(0)"><img alt="Ứng dụng di động  trên iOS/ Android"
                                        src="upload/hinhanh/257591201006107.png"> <span>Ứng dụng di động trên
                                        iOS/ Android</span> </a></div>
                        </li>
                        <li>
                            <div class=" "><a href="javascript:void(0)"><img alt="Kết nối  không giới hạn đầu số"
                                        src="upload/hinhanh/305484172597346.png">
                                    <span>Kết nối không giới hạn
                                        đầu số</span> </a></div>
                        </li>
                        <li>
                            <div class=" "><a href="javascript:void(0)"><img alt="Chặn cuộc gọi vào/ra theo ý muốn"
                                        src="upload/hinhanh/287952256886425.png"> <span>Chặn cuộc gọi vào/ra
                                        theo ý muốn</span> </a></div>
                        </li>
                        <li>
                            <div class=" "><a href="javascript:void(0)"><img alt="Gọi tự động  CSKH/ bán hàng"
                                        src="upload/hinhanh/937674331060856.png"> <span>Gọi tự động CSKH/ bán
                                        hàng</span> </a></div>
                        </li>
                        <li>
                            <div class=" "><a href="javascript:void(0)"><img alt="Không giới hạn  cuộc gọi đồng thời"
                                        src="upload/hinhanh/423027237530298.png"> <span>Không giới hạn cuộc gọi
                ...
                <div id="owl-demo-doitac" class="owl-carousel owl-theme">
                    <div class="item wow fadeInUp" data-wow-delay="0.2s">
                        <a href="#" target="_blank"><img alt="VTC"
                                src="thumb/145x80/2/upload/hinhanh/2290112671000510.png" class="icon-home"></a>
                    </div>
                    <div class="item wow fadeInUp" data-wow-delay="0.4s">
                        <a href="javasctript:void(0)"><img alt="VNPT"
                                src="thumb/145x80/2/upload/hinhanh/3838980828945100.png" class="icon-home"></a>
                    </div>
                    <div class="item wow fadeInUp" data-wow-delay="0.6s">
                        <a href="javasctript:void(0)"><img alt="Viettel"
                                src="thumb/145x80/2/upload/hinhanh/4837561742001570.png" class="icon-home"></a>
                    </div>
                    <div class="item wow fadeInUp" data-wow-delay="0.8s">
                        <a href="https://getfly.vn/" target="_blank"><img alt="getfly"
                                src="thumb/145x80/2/upload/hinhanh/1323751415839850.png" class="icon-home"></a>
                    </div>
                    <div class="item wow fadeInUp" data-wow-delay="0.10s">
                        <a href="javasctript:void(0)"><img alt="Vietnammobile"
                                src="thumb/145x80/2/upload/hinhanh/0145587157336190.png" class="icon-home"></a>
                    </div>
                    ...
                    <div class="item wow fadeInUp" data-wow-delay="0.14s">
                        <a href="javasctript:void(0)"><img alt="VNPT"
                                src="thumb/145x80/2/upload/hinhanh/4729821178149400.png" class="icon-home"></a>
                    </div>
                    <div class="item wow fadeInUp" data-wow-delay="0.16s">
                        <a href="javasctript:void(0)"><img alt="SPT"
                                src="thumb/145x80/2/upload/hinhanh/8440778388039930.png" class="icon-home"></a>
                    </div>
                    <div class="item wow fadeInUp" data-wow-delay="0.18s">
                        <a href="javasctript:void(0)"><img alt="Vinaphone"
                                src="thumb/145x80/2/upload/hinhanh/9110466065154030.png" class="icon-home"></a>
                    </div>
                    <div class="item wow fadeInUp" data-wow-delay="0.20s">
                        <a href="javasctript:void(0)"><img alt="VTC"
                                src="thumb/145x80/2/upload/hinhanh/1916246464951770.png" class="icon-home"></a>
                    </div>
        ...
        <div class="container padding0">
            ...
            <div id="khachhangnoi" class="owl-carousel owl-theme">
                <div class="item wow fadeInUp" data-wow-delay="0.3s">
                    <div class="blockKhachhangnoi">
                        <div class="mainsaycustomer">
                            <img class="logoavatar" src="thumb/86x86/1/upload/baiviet/img3730-4026.JPG" alt="">
                ...
                <div class="item wow fadeInUp" data-wow-delay="0.9s">
                    <div class="blockKhachhangnoi">
                        <div class="mainsaycustomer">
                            <img class="logoavatar" src="thumb/86x86/1/upload/baiviet/termissnal04-9414.png" alt="">
