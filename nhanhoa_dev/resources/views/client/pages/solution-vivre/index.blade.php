                    ...
                    @foreach ($solutions as $solution)
                        <div class="item col-md-3 col-sm-6 col-xsm-6 col-xs-12 wow fadeInUp" data-wow-delay="0.2s">
                            <div class="blockConentPricey ">
                                <h3 class="nameB" style="text-transform: uppercase">{{ $solution->name }}</h3>
                                <ul class="optionPrice">
                                    ...
                                    @if ($solution->fee !== null)
                                        <li class=" liprice  activeprice price1y3">
                                            <b>{{ number_format($solution->fee) }}<span> đ/ tháng</span> </b>
                                        @else
                                        <li class=" liprice  activeprice price1y3"><b>Liên hệ</b>
                                    @endif
                                    </li>
                                </ul>
                                ...
                                <div class="cotentOptionserviceY">
                                    <ul>
                                        <li>Phí khởi tạo: <span
                                                style="color:#eb4762;"><strong>{{ number_format($solution->initialization_fee) }}đ</strong></span>
                                        </li>
                                        <li><strong
                                                style="color: rgb(235, 71, 98);">{{ number_format($solution->branch) }}</strong>
                                            máy nhánh</li>
                                        <li>Không giới hạn cuộc gọi đồng thời</li>
                                        <li>Kết nối 2 đầu số </li>
                                        <li><strong
                                                style="color: rgb(235, 71, 98);">{{ number_format($solution->record_capacity) }}GB</strong>
                                            dung lượng ghi âm
                                        </li>
                    ...
                    <ul class="listinforegiste">
                        ...
                        <li>
                            ...
                            <ul class="listvande">
                                ...
                                <li><input id="input536" type="checkbox" name="vande" value="Ứng dụng " VFone" trên
                                        iOS/ Android"> <label for="input536">Ứng dụng "VFone" trên iOS/
                                        Android</label>
                                </li>
                        ...
                        <li class="linebtnr"><input type="hidden" name="trff"
                                value="VFONE_nhanhoa.com"><button><span>Đăng
                                    ký</span></button></li>
                ...
                <div class="container padding0">
                    ...
                    <div class="conentenPri wow fadeInUp" data-wow-delay="0.2s">
                        ...
                        <ul class="listPrce1 wow fadeInUp" data-wow-delay="0.24s">
                            ...
                            <li>
                                <div class=" "><a href="javascript:void(0)"><img
                                            alt="Kết nối  không giới hạn đầu số" src="upload/hinhanh/305484172597346.png">
                                        <span>Kết nối không giới hạn
                                            đầu số</span> </a></div>
                            </li>
                            <li>
