...
$(document).ready(function() {
    ...
    function fetchservers(page) {
        $.ajax({
            ...
            success: function(data) {
                ...
                $('#pagination-education').html(pagination);
            },
            error: function(xhr, status, error) {
                console.error('Lỗi khi lấy danh sách gg workspace:', error);
            }
        });
    }
    ...
    $(document).on('click', '#pagination-education a', function(event) {
