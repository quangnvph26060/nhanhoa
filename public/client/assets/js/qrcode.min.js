...
$(document).ready(function () {
    ...
    new Swiper(".swiper_lich_su_phat", {
        ...
        spaceBetween: 0,
        breakpoints: {
            1028: { slidesPerView: "5", spaceBetween: 0 },
            900: { slidesPerView: "4", spaceBetween: 0 },
            600: { slidesPerView: "3", spaceBetween: 0 },
        },
    });
    new Swiper(".swiper_pricing_general", {
        navigation: {
            nextEl: ".swiper-button-next",
            prevEl: ".swiper-button-prev",
        },
        ...
        spaceBetween: 20,
        breakpoints: {
            1028: { slidesPerView: "auto", spaceBetween: 30 },
    ...
    new Swiper(".swiper_email_server", {
        ...
        breakpoints: {
            1028: { slidesPerView: "auto", spaceBetween: 30 },
            900: { slidesPerView: "auto", spaceBetween: 20 },
            600: { slidesPerView: "auto", spaceBetween: 20 },
        },
    });
    ...
    new Swiper(".swiper_difference", {
        ...
        spaceBetween: 20,
        breakpoints: {
            1028: { slidesPerView: 4, spaceBetween: 15 },
    ...
    new Swiper(".swiper_advantages_registering", {
        ...
        spaceBetween: 20,
        breakpoints: {
            1028: { slidesPerView: 3, spaceBetween: 15 },
            900: { slidesPerView: 2, spaceBetween: 10 },
            480: { slidesPerView: 1, spaceBetween: 10 },
        },
    });
